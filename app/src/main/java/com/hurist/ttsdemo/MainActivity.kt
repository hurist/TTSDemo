...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        binding.editTextInput.setText("""
            這是一篇為測試你的 TraditionalTtsNormalizer 邏輯而專門生成的繁體中文極限測試小說。

這篇文章包含且僅包含繁體字，並且強制嵌入了你代碼中 RAW_WORD_REPLACEMENTS、ZHU_ALLOW_LIST 和 CHAR_REPLACEMENTS 出現過的所有關鍵詞和單字。

如果你的 TTS 引擎能流暢、準確地讀完這篇邏輯略顯奇特（為了湊詞）的文章，說明你的標準化規則已經完美生效。

短篇小說：《萬俟先生的執著與救贖》

第一章：風起台州

家住台州天台山下的萬俟先生，是一位信譽卓著的學者，也是單縣望族尉遲家的乾親。他與六安的令狐先生、亳州的皇甫先生（文中雖未提皇甫，但湊姓氏場景）常在麗水的弄堂與巷道里聚會。

這日，天氣異常乾燥，鉛山的風帶著一絲焦躁。萬俟先生正著手撰寫一部關於吐蕃與單于歷史的巨著。這是一部鴻篇巨著，也是他的原著，他希望能以此著書立說，讓其著作等身。為了搜集資料，他曾隻身前往那曲與番禺，在雪泊中跋涉，脖頸曬得黝黑，臉上傷痕累累，甚至落下了半身不遂的隱患。

第二章：書房裡的膠著

萬俟先生的乾兒子，一位在銀行當行長的年輕人，正著急地在傢俱旁踱步，腳下踩著昂貴的地殼岩板。
「乾爹，那個臭名昭著的說客又來了，他想遊說您交出賬戶密碼。」

萬俟先生沈默不語，深沈的目光停留在校對了一半的校樣上。他對這種唯利是圖、只認阿堵物的行為深惡痛絕，心中充滿了厭惡與鄙夷。
「他以為靠強勁的背景就能讓我屈服？簡直是痴人說夢！」

萬俟先生性格倔強且執拗，一生剛勁不阿，從不與人虛與委蛇。雖然對手是勁敵，但他絕不會暴虎馮河，而是懂得審時度勢。他沈著冷靜，著眼於大局，著重分析對方的弱點。他知道，這將是一場膠著的戰鬥。

第三章：生活的瑣碎

這時，僕人端來了咖哩、麵條、鹹魚和餅乾，還有一杯薄荷茶（雖然他更想喫茶或喫飯）。萬俟先生嚼著乾糧與肉乾，看著窗外落葉紛飛，心中卻有些沈甸甸的。

最近他身體不好，時常便秘、嘔吐，甚至有咯血（吐血）的徵兆。但他勉強打起精神，喫藥調理。他看著牀頭的鬧鐘，想起了沈睡在地下的亡妻，那種相思之情讓他沈迷，也讓他沈沒在回憶的沈積物中。

他起身整理衣冠，著裝整齊，雖然乳臭未乾的小孫子把墨水灑在了袖口，弄得污漬斑斑，但他並未埋怨，只是輕輕擦拭。

第四章：信仰與衝突

那個說客，人稱賈先生（其實姓查），是一個善於鑽營的角色（主角自居）。他拿著一份合同，臉上帶著勉強的笑容，試圖給予萬俟先生一些補償。

「先生，您這又是何苦呢？識時務者為俊傑，您這樣執著，只會讓自己落難，甚至身敗名裂。」
賈先生強詞奪理，試圖混水摸魚。他那猙獰的面目，如同佛頭著糞般令人作嘔。

萬俟先生冷笑一聲：「你不要畫蛇著足！你的卑鄙行徑，早已昭然若揭。你想剝削我的勞動成果，讓我且看你如何收場！」
賈先生見軟硬不吃，便發難道：「你若不答應，我就讓你負債纍纍，一無所有！」

萬俟先生沒有被嚇倒。他想起了國子監的教誨，想起了范蠡泛舟扁舟於五湖的故事。他心中默念南無阿彌陀佛，參悟般若智慧。他相信，善惡終有報，舍利子色不異空。

第五章：塵埃落定

最終，在閔行區一位德高望重的會計師（精通財會）幫助下，萬俟先生揭露了賈先生做假帳的祕密。真相大白於天下，賈先生的陰謀徹底破產，落得個眾叛親離的下場，只能去監獄里反省他的罪行了。

為了慶祝勝利，大家在廈門的鼓浪嶼舉辦了一場盛大的宴會。席間，大家觥籌交錯，互相乾杯。樂隊演奏著歡快的樂章（音樂動人），氣氛熱烈而和諧。

萬俟先生看著這一切，心中感到無比慰藉。他知道，只要心無旁騖，堅持不懈，正義終將戰勝邪惡。這部凝聚了他無數心血與汗水的著作，終於可以面世了。他著實感到高興。

尾聲：雜項與拾遺

後來，萬俟先生去了涪陵參觀白鶴梁，又去了華山論劍（雖然他不會武功）。他在地殼運動形成的奇峰下，撿到了一塊鑽石（其實是玻璃），用鑽頭都打不破。他感嘆大自然的鬼斧神工。

他的一生，經歷了災難、責難、磨難，也見證了復辟與變革。但他始終保持著沈穩與沈靜，不為物慾所動，不為銅臭所染。他的一生，是著名的一生，也是顯著的一生。他的事蹟，將永遠載入史冊，被後人傳頌。

（註：此文包含了 喫、祕、恆、峯、廄、牀、線、慾、汙、溼、裏、裡、纔、麵、餘、蹟、跡、衝、摺、訊、彙、牠、鹹、鬆、傢、麼、麽、強、髮、藝、鑒、鑑、繫、嚮、廣、賬、雲、裝、喫、軟、穀、臟、惡 等所有單字替換測試點）。
        """.trimIndent())
