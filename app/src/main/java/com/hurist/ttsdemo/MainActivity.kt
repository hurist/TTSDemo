...
他因違紀受了處分，但此處分布著許多地雷。（測試：處分 vs 此處分布）
這種行為真可惡，但我們不能認可惡勢力的邏輯。（測試：可惡 vs 認可惡）
他工作很稱職，但這個名稱職位並不適合他。（測試：稱職 vs 名稱職位）
匈奴單于驍勇善戰，這份名單于是被公佈了。（測試：單于 vs 名單于是）
我要去銀行存錢，物理老師說水銀行為流動狀。（測試：銀行 vs 水銀行為）
公司的會計正在算賬，但他還沒學會計算機操作。（測試：會計 vs 學會計算）
這篇文章需要重寫，系統正在將權重寫入資料庫。（測試：重寫 vs 權重寫入）
銀行的行長正在講話，這次債券的發行長度為三年。（測試：行長 vs 發行長度）
【生活、職業與特殊名詞】
古代女子擅長女紅，那位美女紅光滿面。（測試：女紅 vs 美女紅）
這是一支千年人參，此人參與了昨晚的行動。（測試：人參 vs 此人參與）
他老家在台州，這家銀行提供櫃台州際匯款服務。（測試：台州 vs 櫃台州）
老僧口唸南無阿彌陀佛，河南無人機產業發展迅速。（測試：南無 vs 河南無）
江西鉛山縣很有名，這座廢棄的鉛山脈汙染嚴重。（測試：鉛山 vs 鉛山脈）
這裡的巷道非常狹窄，但這條小巷道路很平整。（測試：巷道 vs 小巷道路）
他因給予太多壓力而咯血，這張卡咯噔一下就壞了。（測試：給予/咯血 vs 卡咯）
他做事很勉強，依靠強詞奪理來掩飾倔強的性格。（測試：勉強/強詞奪理 vs 倔強）
醫生大夫正在開藥，他是古代的士大夫階層。（測試：大夫-醫生 vs 士大夫）
他的角色是電影主角，兩人為了搶戲發生了口角。（測試：角色/主角 vs 口角）
【極限「著」字與語義陷阱】
面對危機要沈著冷靜，老沈著急地跑了過來。（測試：沈著 vs 老沈著急）
他一生著書立說，現在正安靜地看著書。（測試：著書 vs 看著書）
這位著名作家的著作非常顯著，但他穿著很隨意。（測試：著名/著作 vs 穿著）
他對藝術很執著，兩人為此爭執著不肯罷休。（測試：執著 vs 爭執著）
天氣乾燥，他吃著餅乾，想著乾隆皇帝的乾坤大挪移。（測試：乾燥/餅乾 vs 乾隆/乾坤）
【綜合連環炮】
單于正在校正地圖，名單于是放在了桌上，學校正在上課。（測試：多詞混合）
會計算錯了賬，導致銀行的行長非常可惡，但不能認可惡意報復。（測試：多詞混合）
沈先生在沈著書，為人沈著，從不沈不住氣。（測試：沈-姓氏 vs 沈著書 vs 沈著-形容詞）
這具軀殼雖然看似金蟬脫殼，但實際上脈脈含情。（測試：軀殼/脫殼 vs 脈脈）
他從六安出發，路過麗水，在閔行區吃了餛飩。（測試：六安/麗水/閔行）
        """.trimIndent()
